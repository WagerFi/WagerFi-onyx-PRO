  ...
  return (
    <div className="min-h-screen" style={{ background: '#0a0a0a' }}>
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <motion.button
            className="px-2 py-1 text-[10px] font-medium text-white rounded-md transition-all"
            style={{ 
              fontFamily: 'Geist, sans-serif',
              background: 'linear-gradient(135deg, rgba(45, 45, 45, 0.95), rgba(30, 30, 30, 0.95))',
              border: '1px solid rgba(255, 255, 255, 0.1)',
          ...
          <motion.button
            className="px-2 py-1 text-[10px] font-medium text-gray-400 hover:text-white rounded-md transition-all"
            style={{ 
              fontFamily: 'Geist, sans-serif',
